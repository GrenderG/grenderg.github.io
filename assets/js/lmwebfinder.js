...
function search(textToFind) {
    ...
    document.getElementsByClassName("goFind")[lastMatch].style.backgroundColor = "#272935"; //changes the color of the actual match in order to diffenciate from others
